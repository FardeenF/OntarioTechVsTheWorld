...
/// <summary>
/// This class is responsible for calculating the distance between touch positions and returns the angle to PinchToRotate.cs 
/// </summary>
...
public class DetectTouchMovement : MonoBehaviour
{
	...
	/// <summary>
	/// Function used to calculate the angle between two touch points
	/// </summary>
